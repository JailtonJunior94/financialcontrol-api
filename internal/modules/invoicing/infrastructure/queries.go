...
const (
	...
	addInvoiceItem     = `INSERT INTO dbo.[InvoiceItem] VALUES (@id, @invoiceId, @categoryId, @purchaseDate, @description, @totalAmount, @installment, @installmentValue, @tags, @createdAt, @updatedAt, @active, @invoiceControl)`
	getLastControl     = `SELECT TOP 1 [InvoiceControl] FROM dbo.[InvoiceItem] ORDER BY [InvoiceControl] DESC`
	...
	getInvoiceItemsByControl = `SELECT
										CAST(II.[Id] AS CHAR(36)) [Id],
										CAST(II.[InvoiceId] AS CHAR(36)) [InvoiceId],
										CAST(II.[CategoryId] AS CHAR(36)) [CategoryId],
										II.PurchaseDate,
									...
									ORDER BY
										II.InvoiceControl`
	getInvoiceItemsByInvoiceID = `SELECT
									CAST(II.[Id] AS CHAR(36)) [Id],
									CAST(II.[InvoiceId] AS CHAR(36)) [InvoiceId],
									CAST(II.[CategoryId] AS CHAR(36)) [CategoryId],
									II.[PurchaseDate],
