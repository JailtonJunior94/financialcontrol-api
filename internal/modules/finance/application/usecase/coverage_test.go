...
func TestRefundTransaction_RefundOfRefund_ReturnsError(t *testing.T) {
	...
	txRepo.On("GetByID", mock.Anything, userID, txID).Return(refundTx, nil)
...
func TestRefundTransaction_HasActiveRefundForError(t *testing.T) {
	...
	txRepo.On("HasActiveRefundFor", mock.Anything, userID, txID).Return(false, repoErr)
...
func TestUpdateTransaction_SubcategoryNotFound_ReturnsError(t *testing.T) {
	...
	cats.On("GetByID", mock.Anything, userID, subcatID).Return(projections.CategoryView{}, errors.New("not found"))
...
func TestUpdateTransaction_SubcategoryNotActive_ReturnsError(t *testing.T) {
	...
	cats.On("GetByID", mock.Anything, userID, subcatID).Return(inactiveSub, nil)
...
func TestUpdateTransaction_ListByTransactionError(t *testing.T) {
	...
	tx := newExpenseTransaction(t, userID)
	txRepo.On("GetByID", mock.Anything, userID, txID).Return(tx, nil)
	instRepo.On("ListByTransaction", mock.Anything, txID).Return(nil, repoErr)
...
func TestCreateTransaction_SubcategoryNotFound_ReturnsError(t *testing.T) {
	...
	cats.On("GetByID", mock.Anything, userID, catID).Return(newActiveCategoryView(userID, catID), nil)
	cats.On("GetByID", mock.Anything, userID, subcatID).Return(projections.CategoryView{}, domain.ErrCategoryNotFound)
...
func TestListTransactions_InvRepoListError(t *testing.T) {
	...
	clock.On("Now").Return(fixedNow)
	invRepo.On("List", mock.Anything, userID, mock.AnythingOfType("filters.InvoiceFilter")).Return([]entities.Invoice{}, int64(0), repoErr)
...
func TestListTransactions_LazyClose_UpdateError(t *testing.T) {
	...
	invRepo.On("Update", mock.Anything, mock.AnythingOfType("*entities.Invoice")).Return(updateErr)
...
func TestCreateTransaction_IdempotencyGetError(t *testing.T) {
	...
	idempRepo.On("Get", mock.Anything, userID, "POST /finance/transactions", key.Value()).Return(nil, repoErr)
...
func TestDeleteTransaction_HasClosedOrPaidInstallmentError(t *testing.T) {
	...
	txRepo.On("GetByID", mock.Anything, userID, txID).Return(tx, nil)
	txRepo.On("HasActiveRefundFor", mock.Anything, userID, txID).Return(false, nil)
	instRepo.On("HasClosedOrPaidForTransaction", mock.Anything, txID).Return(false, repoErr)
