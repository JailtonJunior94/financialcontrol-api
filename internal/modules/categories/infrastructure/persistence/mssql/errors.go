...
// MapDriverError translates SQL Server driver errors raised by the categories
// repository into domain sentinels. Returns the original error untouched when
// no mapping applies, preserving the wrapped chain for the caller.
